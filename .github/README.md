...
[`@aws-sdk/client-pca-connector-scep`](https://www.npmjs.com/package/@aws-sdk/client-pca-connector-scep/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DMGPjd2nGqLKbgNRzkSm783/SlKH1pYh/Hpx4leOrnnMtCTwezn5HRYvc9FDxie7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pca-connector-scep": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.848.0/index.min.mjs": "sha384-DMGPjd2nGqLKbgNRzkSm783/SlKH1pYh/Hpx4leOrnnMtCTwezn5HRYvc9FDxie7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pca-connector-scep/blob/refs/tags/3.848.0/LICENSE
```

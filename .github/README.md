...
[`@aws-sdk/client-pca-connector-scep`](https://www.npmjs.com/package/@aws-sdk/client-pca-connector-scep/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g+dCD4Pec4V78pUyppEx6zM77T4jVBaKBcZ1mDkiBomBDvnE3TiFZChm5flhM6Uo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pca-connector-scep": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.670.0/index.min.mjs": "sha384-g+dCD4Pec4V78pUyppEx6zM77T4jVBaKBcZ1mDkiBomBDvnE3TiFZChm5flhM6Uo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pca-connector-scep/blob/refs/tags/3.670.0/LICENSE
```

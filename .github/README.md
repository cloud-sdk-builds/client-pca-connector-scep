...
[`@aws-sdk/client-pca-connector-scep`](https://www.npmjs.com/package/@aws-sdk/client-pca-connector-scep/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OZnAa5uBpFeugD6QAwCG6cYVDb5YuLLSnwn+7G47nBeo3IXIBBAQSTjXeNSKF4Di
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pca-connector-scep": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.816.0/index.min.mjs": "sha384-OZnAa5uBpFeugD6QAwCG6cYVDb5YuLLSnwn+7G47nBeo3IXIBBAQSTjXeNSKF4Di"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pca-connector-scep/blob/refs/tags/3.816.0/LICENSE
```

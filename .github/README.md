...
[`@aws-sdk/client-pca-connector-scep`](https://www.npmjs.com/package/@aws-sdk/client-pca-connector-scep/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bkcKFO0BAp+J5gVYNwooa71tLOtfqWLex+DBc1oY8Vlzr4KfIkE0tDncAJzRcbDh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-pca-connector-scep": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-pca-connector-scep@3.985.0/index.min.mjs": "sha384-bkcKFO0BAp+J5gVYNwooa71tLOtfqWLex+DBc1oY8Vlzr4KfIkE0tDncAJzRcbDh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-pca-connector-scep/blob/refs/tags/3.985.0/LICENSE
```
